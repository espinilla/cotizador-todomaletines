            ...
            {activeTab === 'items' && (
              <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                 <div className="flex justify-between items-center bg-blue-50 p-3 rounded-lg border border-blue-100">
                    <div><p className="text-xs text-blue-800 font-bold">TOTAL A PAGAR (Inc. IGV)</p><p className="text-xl font-bold text-blue-900">{quoteMeta.currency} {totalWithTax.toFixed(2)}</p></div>
